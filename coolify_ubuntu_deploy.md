...
RESEND_API_KEY=...
RESEND_FROM_EMAIL="Fertility Center Cancun <contacto@tu-dominio.com>"
LEAD_NOTIFICATION_EMAILS=correo-adicional@tu-dominio.com
OPENAI_API_KEY=...
OPENAI_TRANSLATION_MODEL=gpt-4.1-mini
CRM_WEBHOOK_URL=...
CRM_WEBHOOK_TOKEN=...
REQUIRE_CRM_DELIVERY=false
UPNIFY_INTEGRATION_URL_ES=https://api.upnify.com/v4/integraciones/...
UPNIFY_INTEGRATION_URL_EN=https://api.upnify.com/v4/integraciones/...
# alternativas a las URLs
UPNIFY_INTEGRATION_TOKEN_ES=...
UPNIFY_INTEGRATION_TOKEN_EN=...
UPNIFY_TREATMENT_FIELD=tratamiento
UPNIFY_COUNTRY_FIELD=pais
```
...
- Las integraciones ES y EN deben tener su fase, origen y etiqueta configurados directamente en Upnify.
- `UPNIFY_TREATMENT_FIELD` debe coincidir exactamente con el nombre API del campo personalizado de texto creado en el CRM.
